...
import 'package:asset_management_api/features/asset_migration/domain/usecases/create_asset_consumable_use_case.dart';
import 'package:asset_management_api/features/asset_migration/domain/usecases/create_new_asset_use_case.dart';
import 'package:asset_management_api/features/asset_migration/domain/usecases/find_all_asset_use_case.dart';
...
class AssetMigrationResponse {
  ...
  static Future<Response> createNewAsset(RequestContext context) async {
    ...
    if (!validateToken) {
      ...
      final isConsumable = params['is_consumable'] as int;

      if (isConsumable == 1) {
        final usecase = context.read<CreateAssetConsumableUseCase>();
        ...
        final usecase = context.read<CreateNewAssetUseCase>();
  ...
  static Future<Response> findAllAsset(RequestContext context) async {
    ...
    if (!validateToken) {
      ...
      final usecase = context.read<FindAllAssetMigrationUseCase>();
