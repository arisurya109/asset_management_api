...
class FindBrandByIdAssetUseCase {
  FindBrandByIdAssetUseCase(this._repository);

  final BrandRepository _repository;

  Future<Either<Failure, List<Brand>>> call(int params) async {
    return _repository.findBrandByIdAsset(params);
  }
}
