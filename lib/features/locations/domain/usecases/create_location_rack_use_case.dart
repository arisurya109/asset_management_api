...
class CreateLocationRackUseCase {
  CreateLocationRackUseCase(this._repository);

  final LocationRepository _repository;

  Future<Either<Failure, LocationRack>> call(LocationRack params) async {
    return _repository.createLocationRack(params);
  }
}
