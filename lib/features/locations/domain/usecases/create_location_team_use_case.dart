...
class CreateLocationTeamUseCase {
  CreateLocationTeamUseCase(this._repository);

  final LocationRepository _repository;

  Future<Either<Failure, LocationTeam>> call(LocationTeam params) async {
    return _repository.createLocationTeam(params);
  }
}
