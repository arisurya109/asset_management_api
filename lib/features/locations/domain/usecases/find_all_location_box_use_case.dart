...
class FindAllLocationBoxUseCase {
  FindAllLocationBoxUseCase(this._repository);

  final LocationRepository _repository;

  Future<Either<Failure, List<LocationBox>>> call() async {
    return _repository.findAllLocationBox();
  }
}
