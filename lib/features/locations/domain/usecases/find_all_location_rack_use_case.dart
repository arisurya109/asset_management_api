...
class FindAllLocationRackUseCase {
  FindAllLocationRackUseCase(this._repository);

  final LocationRepository _repository;

  Future<Either<Failure, List<LocationRack>>> call() async {
    return _repository.findAllLocationRack();
  }
}
