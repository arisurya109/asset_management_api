...
class FindAllLocationTeamUseCase {
  FindAllLocationTeamUseCase(this._repository);

  final LocationRepository _repository;

  Future<Either<Failure, List<LocationTeam>>> call() async {
    return _repository.findAllLocationTeam();
  }
}
