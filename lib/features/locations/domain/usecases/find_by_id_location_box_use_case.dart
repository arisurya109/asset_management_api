...
class FindByIdLocationBoxUseCase {
  FindByIdLocationBoxUseCase(this._repository);

  final LocationRepository _repository;

  Future<Either<Failure, LocationBox>> call(int params) async {
    return _repository.findByIdLocationBox(params);
  }
}
