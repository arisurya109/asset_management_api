...
class FindAllModulePermissionUseCase {
  FindAllModulePermissionUseCase(this._repository);

  final ModulePermissionRepository _repository;

  Future<Either<Failure, List<ModulePermission>>> call() async {
    return _repository.findAllModulePermission();
  }
}
