...
class UpdateStatusAssignedPreparationUseCase {
  UpdateStatusAssignedPreparationUseCase(this._repository);
  ...
  Future<Either<Failure, Preparation>> call({
    ...
    return _repository.updateStatusAssignedPreparation(id: id, userId: userId);
  }
}
