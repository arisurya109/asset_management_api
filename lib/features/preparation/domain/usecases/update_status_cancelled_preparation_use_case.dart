...
class UpdateStatusCancelledPreparationUseCase {
  UpdateStatusCancelledPreparationUseCase(this._repository);
  ...
  Future<Either<Failure, Preparation>> call({
    ...
    return _repository.updateStatusCancelledPreparation(id: id, userId: userId);
  }
}
